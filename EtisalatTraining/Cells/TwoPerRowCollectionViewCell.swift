...
class TwoPerRowCollectionViewCell: UICollectionViewCell {
    ...
    func setupCell(photo:Data?, title:String, price:Double, sale:String, shippedAt:String, shipedFrom: String, rating:Double){
